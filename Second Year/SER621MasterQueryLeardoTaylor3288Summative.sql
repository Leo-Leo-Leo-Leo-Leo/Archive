...
CREATE NONCLUSTERED COLUMNSTORE INDEX NC_CS_ProductName ON Product(ProductName) GO

CREATE OR ALTER VIEW [dbo].[March Orders] AS
SELECT [OrderDate] AS [Date Ordered], [OrderNumber] AS [Order Number]
FROM [dbo].[Order]
WHERE MONTH([OrderDate]) = 3;
GO

CREATE OR ALTER VIEW [dbo].[Customer Products] AS
SELECT ([Customer].[FirstName] + [Customer].[LastName]) AS [Customer Name], [Product].[ProductName] AS [Product]
FROM [dbo].[Customer] 
	INNER JOIN [dbo].[Order] ON [Order].[CustomerId] = [Customer].[Id]
	INNER JOIN [dbo].[OrderItem] ON [OrderItem].[OrderId] = [Order].[Id]
	INNER JOIN [dbo].[Product] ON [Product].[Id] = [OrderItem].[ProductId]
GO

CREATE OR ALTER VIEW [dbo].[Supplier Products] AS
SELECT [Supplier].[CompanyName], [Product].[ProductName]
FROM [dbo].[Supplier]
	INNER JOIN [dbo].[Product] ON [Product].[SupplierId] = [Supplier].[Id]
WHERE [Product].[IsDiscontinued] = 0;
GO

CREATE OR ALTER VIEW [dbo].[Order Details] AS
SELECT ([Customer].[FirstName] + [Customer].[LastName]) AS [Customer Name], [Product].[ProductName] AS [Product],
	[OrderItem].[Quantity] AS [Number Of], ([OrderItem].[UnitPrice] * [OrderItem].[Quantity]) AS [Final Price], [Supplier].[CompanyName] AS [Supplier Name]
FROM [dbo].[Customer] 
	INNER JOIN [dbo].[Order] ON [Order].[CustomerId] = [Customer].[Id]
	INNER JOIN [dbo].[OrderItem] ON [OrderItem].[OrderId] = [Order].[Id]
	INNER JOIN [dbo].[Product] ON [Product].[Id] = [OrderItem].[ProductId]
	INNER JOIN [dbo].[Supplier] ON [Supplier].[Id] = [Product].[SupplierId]
GO
-----------------------------------------------------------------------------------------------------------------------------------uspinsert
CREATE OR ALTER PROCEDURE [dbo].[USP_INSERT_Customer]
...
AS 
BEGIN
	INSERT INTO [dbo].Customer (FirstName, LastName, City, Phone)
	VALUES (@FirstName, @LastName, @City, @Phone)
END
GO

CREATE OR ALTER PROCEDURE [dbo].[USP_INSERT_Order]
@OrderNumber NVARCHAR(10),
@CustomerId INT,
@TotalAmount Decimal(12,2)
AS 
BEGIN
	INSERT INTO [dbo].[Order] (OrderNumber, CustomerId, TotalAmount)
	VALUES (@OrderNumber, @CustomerId, @TotalAmount)
END
GO

CREATE OR ALTER PROCEDURE [dbo].[USP_INSERT_OrderItem]
@OrderId INT,
@ProductId INT,
...
CREATE OR ALTER PROCEDURE [dbo].[USP_INSERT_Supplier]
...
GO
-----------------------------------------------------------------------------------------------------------------------------------uspupdate
CREATE OR ALTER PROCEDURE [dbo].[USP_UPDATE_Customer]
@Id INT,
@FirstName NVARCHAR(40),
@LastName NVARCHAR(40),
@City NVARCHAR(40),
...
BEGIN
	UPDATE [dbo].[Customer] 
	SET  FirstName = @FirstName, LastName = @LastName, City = @City, Phone = @Phone
	WHERE Id = @Id; 
END
GO

CREATE OR ALTER PROCEDURE [dbo].[USP_UPDATE_Order]
@Id INT,
@OrderNumber NVARCHAR(10),
@CustomerId INT,
@TotalAmount Decimal(12,2)
...
BEGIN
	UPDATE [dbo].[Order] 
	SET  OrderNumber = @OrderNumber, CustomerId = @CustomerId, TotalAmount = @TotalAmount
	WHERE Id = @Id; 
END
GO

CREATE OR ALTER PROCEDURE [dbo].[USP_UPDATE_OrderItem]
@Id INT,
@OrderId INT,
@ProductId INT,
@UnitPrice DECIMAL(12,2),
...
BEGIN
	UPDATE [dbo].[Product] 
	SET  ProductName = @ProductName, SupplierId = @SupplierId, UnitPrice = @UnitPrice, Package = @Package, IsDiscontinued = @IsDiscontinued 
	WHERE Id = @Id; 
END
GO

CREATE OR ALTER PROCEDURE [dbo].[USP_UPDATE_Supplier]
@Id INT,
@CompanyName NVARCHAR(40),
@ContactName NVARCHAR(50),
@ContactTitle NVARCHAR(40),
...
BEGIN
	UPDATE [dbo].[Supplier] 
	SET  CompanyName = @CompanyName, ContactName = @ContactName, ContactTitle = @ContactTitle, City = @City, Country = @Country, Phone = @Phone, Fax = @Fax
	WHERE Id = @Id; 
END
GO
...
CREATE OR ALTER PROCEDURE [dbo].[USP_DELETE_Customer]
@Id INT
AS 
BEGIN
	DELETE
...
CREATE OR ALTER PROCEDURE [dbo].[USP_DELETE_Order]
@Id INT
AS 
BEGIN
	DELETE
...
CREATE OR ALTER PROCEDURE [dbo].[USP_DELETE_OrderItem]
@Id INT
AS 
BEGIN
	DELETE
...
CREATE OR ALTER PROCEDURE [dbo].[USP_DELETE_Product]
@Id INT
AS 
BEGIN
	DELETE
...
CREATE OR ALTER PROCEDURE [dbo].[USP_DELETE_Supplier]
@Id INT
AS 
BEGIN
	DELETE
...
---------------------------------------------------------------------------------------------------------triggers
--CREATE OR ALTER TRIGGER [dbo].[Cust_Archived]
--ON [dbo].[Supplier]
--AFTER DELETE 
--AS
--BEGIN
...
--if NOT EXISTS (select 1 from sysobjects where  id = object_id('Archived_Products') and type = 'U')
--		BEGIN 
--			CREATE TABLE [dbo].[Archived_Products] (
--			Id                   int                  identity,
--			ProductName          nvarchar(50)         not null,
--			SupplierId           int                  not null,
--			UnitPrice            decimal(12,2)        null default 0,
...
--		INSERT INTO [dbo].[Archived_Products] (Id, ProductName,)
--		VALUES
--END
--GO

CREATE OR ALTER TRIGGER [dbo].[Supplier_Deleted]
ON [dbo].[Supplier]
AFTER DELETE 
AS
BEGIN
...
--CREATE OR ALTER TRIGGER [dbo].[Product_Deleted]
--ON [dbo].[Product]
--AFTER UPDATE
--AS
--BEGIN
...
---------------------------------------------------------------------------------------------------------USP
CREATE OR ALTER PROCEDURE [dbo].[SELECT_TABLE]
...
SET @sql ='SELECT ' + @Columns + 'FROM ' + @Tables
EXEC sp_executesql @SQL

END
GO

CREATE OR ALTER PROCEDURE [dbo].[SELECT_Num_Enrties]
 @Tables NVARCHAR(500)
AS
BEGIN
SET TRANSACTION ISOLATION LEVEL REPEATABLE READ
...
SET @sql ='SELECT ' +  COUNT(*) + 'FROM ' + @Tables
EXEC sp_executesql @SQL
END
GO

CREATE OR ALTER PROCEDURE [dbo].[SELECT_Discontinued_Products]
AS
BEGIN
SET TRANSACTION ISOLATION LEVEL REPEATABLE READ
